...
public class CourseService {
    ...
    @Transactional
    private void updateCourseStudents(Course course, List<Long> studentIds) throws Exception {
        try
        {
    ...
    @Transactional
    private void updateCourseFaculty(Course course, List<Long> facultyIds) throws Exception {
        try
        {
