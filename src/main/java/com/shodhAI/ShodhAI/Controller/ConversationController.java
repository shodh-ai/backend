...
public class ConversationController {
    ...
    public ResponseEntity<?> addDoubt(HttpServletRequest request, @RequestBody ConversationDto conversationDto, @RequestHeader(value = "Authorization") String authHeader) {
        try {
